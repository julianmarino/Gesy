...
import rts.PlayerActionScriptGeneration;

/**
 *
 * @author Rubens
 * Alpha-Beta com inimigo livre e podendo utilizar todas as possibilidades de ações.
 */
public class ABSelection extends AIWithComputationBudget implements InterruptibleAI {

    public static int DEBUG = 0;
    
    int MAX_DEPTH = 2000; // if search goes beyond this point, most likely we are done 50 original
    ...
    GameState gs_OriginalCopy = null;
    ...
    //scripts a serem utilizados pelo PlayerActionScriptGeneration
    ArrayList<AI> scripts = new ArrayList<>();
    //ScriptMin will be used just when we have an abstractied action space for Min player
    ArrayList<AI> scriptsMin = new ArrayList<>();
    
    public ABSelection(UnitTypeTable utt) {
        this(100, -1, 
             new LightRush(utt, new AStarPathFinding()), 100, 
             new EvalSelection(), true);
        //1 min = 60000 ms
        //usando 1800000
    }

    
    public ABSelection(int tpc, int ppc, AI a_playoutAI, int a_maxPlayoutTime, EvaluationFunction a_ef, boolean a_performGreedyActionScan) {
        super(tpc, ppc);
    ...
    public AI clone() {
        return new ABSelection(TIME_BUDGET, ITERATIONS_BUDGET, playoutAI, maxPlayoutTime, ef, performGreedyActionScan);
    }
    ...
    public final PlayerAction getAction(int player, GameState gs) throws Exception
    {
        if (gs.canExecuteAnyAction(player)) {
            ...
            //return playoutAI.getAction(player, gs_to_start_from);
...
//        return bestMove;
    ...
    public PlayerAction getBestActionSoFar() throws Exception {
        ...
        if (bestMove == null) {
            PlayerActionScriptGeneration pag = new PlayerActionScriptGeneration(gs_to_start_from,playerForThisComputation, scripts);
            return pag.getRandom();
        }
        return bestMove;
    }
    ...
    public PlayerAction greedyActionScan(GameState gs, int player, long cutOffTime, int maxPlayouts) throws Exception {
        ...
        float bestScore = 0;
        PlayerActionScriptGeneration pag = new PlayerActionScriptGeneration(gs,player, scripts);
...
//                                System.out.println("last result from -1 node");
                ...
                case 0: // max node:
                        ...
                        if (current.actions == null) {
                            current.actions = new PlayerActionScriptGeneration(current.gs, maxplayer, scripts);
    ...
    //                            while(current.actions.size()>MAX_BRANCHING_FACTOR) current.actions.remove(r.nextInt(current.actions.size()));
                ...
                case 1: // min node:
                        ...
                        if (current.actions == null) {
                            ...
                            //Uncomment the next line if you are working with abstraction for player Min
                            current.actions = new PlayerActionScriptGeneration(current.gs, minplayer, scriptsMin);
                            current.actions.randomizeOrder();
                            long l = current.actions.getSize();
                            if (DEBUG>=2) {
                                for(int i = 0;i<current.depth;i++) System.out.print(" ");
...
//        System.out.println("searchOutsideStack: stack is not empty.");
    ...
    public ArrayList<AI> getScripts() {
        return scripts;
    }

    public void setScripts(ArrayList<AI> scripts) {
        this.scripts = scripts;
    }


	/**
	 * @return the scriptsMin
	 */
	public ArrayList<AI> getScriptsMin() {
		return scriptsMin;
	}


	/**
	 * @param scriptsMin the scriptsMin to set
	 */
	public void setScriptsMin(ArrayList<AI> scriptsMin) {
		this.scriptsMin = scriptsMin;
	}
	...
	/**
	 * @return the avg_depth_so_far
	 */
	public int getAvg_depth_so_far() {
		return avg_depth_so_far;
	}


	/**
	 * @return the count_depth_so_far
	 */
	public int getCount_depth_so_far() {
		return count_depth_so_far;
	}


	/**
	 * @return the avg_branching_so_far
	 */
	public long getAvg_branching_so_far() {
		return avg_branching_so_far;
	}


	/**
	 * @return the count_branching_so_far
	 */
	public int getCount_branching_so_far() {
		return count_branching_so_far;
	}


	/**
	 * @return the avg_leaves_so_far
	 */
	public long getAvg_leaves_so_far() {
		return avg_leaves_so_far;
	}


	/**
	 * @return the count_leaves_so_far
	 */
	public int getCount_leaves_so_far() {
		return count_leaves_so_far;
	}


	/**
	 * @return the avg_nodes_so_far
	 */
	public long getAvg_nodes_so_far() {
		return avg_nodes_so_far;
	}


	/**
	 * @return the count_nodes_so_far
	 */
	public int getCount_nodes_so_far() {
		return count_nodes_so_far;
	}


	/**
	 * @return the max_potential_branching_so_far
	 */
	public long getMax_potential_branching_so_far() {
		return max_potential_branching_so_far;
	}


	/**
	 * @return the avg_potential_branching_so_far
	 */
	public long getAvg_potential_branching_so_far() {
		return avg_potential_branching_so_far;
	}


	/**
	 * @return the count_potential_branching_so_far
	 */
	public int getCount_potential_branching_so_far() {
		return count_potential_branching_so_far;
	}


	/**
	 * @return the nPlayouts
	 */
	public int getnPlayouts() {
		return nPlayouts;
	}
	...
	/**
	 * @return the max_depth_so_far
	 */
	public int getMax_depth_so_far() {
		return max_depth_so_far;
	}


	/**
	 * @return the max_branching_so_far
	 */
	public long getMax_branching_so_far() {
		return max_branching_so_far;
	}


	/**
	 * @return the max_leaves_so_far
	 */
	public long getMax_leaves_so_far() {
		return max_leaves_so_far;
	}


	/**
	 * @return the max_nodes_so_far
	 */
	public long getMax_nodes_so_far() {
		return max_nodes_so_far;
	}


	/**
	 * @return the maxPlayoutTime
	 */
	public int getMaxPlayoutTime() {
		return maxPlayoutTime;
	}
	 ...
	 * @return the ef
	 */
	public EvaluationFunction getEf() {
		return ef;
	}


	/**
	 * @return the max_consecutive_frames_searching_so_far
	 */
	public int getMax_consecutive_frames_searching_so_far() {
		return max_consecutive_frames_searching_so_far;
	}


	/**
	 * @return the gs_to_start_from
	 */
	public GameState getGs_to_start_from() {
		return gs_to_start_from;
	}


	/**
	 * @return the gs_OriginalCopy
	 */
	public GameState getGs_OriginalCopy() {
		return gs_OriginalCopy;
	}


	/**
	 * @return the consecutive_frames_searching
	 */
	public int getConsecutive_frames_searching() {
		return consecutive_frames_searching;
	}


	/**
	 * @return the last_depth
	 */
	public int getLast_depth() {
		return last_depth;
	}


	/**
	 * @return the last_nleaves
	 */
	public int getLast_nleaves() {
		return last_nleaves;
	}


	/**
	 * @return the last_nnodes
	 */
	public int getLast_nnodes() {
		return last_nnodes;
	}


	/**
	 * @return the last_time_depth
	 */
	public int getLast_time_depth() {
		return last_time_depth;
	}


	/**
	 * @return the time_depth
	 */
	public int getTime_depth() {
		return time_depth;
	}


	/**
	 * @return the max_time_depth_so_far
	 */
	public int getMax_time_depth_so_far() {
		return max_time_depth_so_far;
	}


	/**
	 * @return the avg_time_depth_so_far
	 */
	public long getAvg_time_depth_so_far() {
		return avg_time_depth_so_far;
	}


	/**
	 * @return the count_time_depth_so_far
	 */
	public double getCount_time_depth_so_far() {
		return count_time_depth_so_far;
	}


	/**
	 * @return the treeIsComplete
	 */
	public boolean isTreeIsComplete() {
		return treeIsComplete;
	}
	 ...
	 */
	public Pair<PlayerAction, Float> getLastResult() {
		return lastResult;
	}
	...
	/**
	 * @return the bestMoveValue
	 */
	public float getBestMoveValue() {
		return bestMoveValue;
	}


	/**
	 * @return the playerForThisComputation
	 */
	public int getPlayerForThisComputation() {
		return playerForThisComputation;
	}
