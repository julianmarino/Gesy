 ...
 * @author rubens
 */
public class EditedPGSmRTS extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public EditedPGSmRTS(UnitTypeTable utt) {
        this(100, -1, 200, 4, 4,
    ...
    public EditedPGSmRTS(UnitTypeTable utt, List<AI> scripts) {
        this(100, -1, 200, 4, 4,
                new SimpleSqrtEvaluationFunction3(),
                //new SimpleSqrtEvaluationFunction2(),
                //new LanchesterEvaluationFunction(),
    ...
    public EditedPGSmRTS(UnitTypeTable utt, List<AI> scripts, String tuplaIndSc) {
        this(100, -1, 200, 4, 4,
                new SimpleSqrtEvaluationFunction3(),
                //new SimpleSqrtEvaluationFunction2(),
                //new LanchesterEvaluationFunction(),
    ...
    public EditedPGSmRTS(UnitTypeTable utt, List<AI> scripts, String tuplaIndSc, int qtdPlayout, int lookahead) {
    ...
    public EditedPGSmRTS(int time, int max_playouts, int la, int a_I, int a_R, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf) {
    ...
    public EditedPGSmRTS(int time, int max_playouts, int la, int a_I, int a_R, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf, List<AI> scripts) {
        super(time, max_playouts);
    ...
    public PlayerAction getBestActionSoFar() throws Exception {
        ...
        if ((System.currentTimeMillis() - start_time) < TIME_BUDGET) {
            ...
            //System.out.println("PGS time out");
        }
        //teste
    ...
    protected AI getSeedPlayer(int player) throws Exception {
        ...
        for (AI script : scripts) {
            ...
            if ((System.currentTimeMillis() - start_time) > (TIME_BUDGET - 20)) {
                //System.out.println("PGS seed is time out");
                return seed;
            }
        }
    ...
    @Override
    public AI clone() {
        return new EditedPGSmRTS(TIME_BUDGET, ITERATIONS_BUDGET, LOOKAHEAD, I, R, evaluation, utt, pf, scripts);
    }
