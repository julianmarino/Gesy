...
public class LeitorLog {
	...
	public LeitorLog(){
		...
		//pathStruture = System.getProperty("user.dir").concat("\\commandsUsed\\COMM1");
		System.out.println("path logs "+pathStruture);
	}
	...
	public ArrayList<EvalResult> processar() {
		...
		System.out.println("path logs validation"+pathStruture);
