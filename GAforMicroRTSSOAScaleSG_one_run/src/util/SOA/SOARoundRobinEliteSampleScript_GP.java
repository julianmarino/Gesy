 ...
 */
public class SOARoundRobinEliteSampleScript_GP {
    ...
    private static final ArrayList<String> SCRIPTS = new ArrayList<String>(Arrays.asList("NS", "A3N", "WR"));
    ...
    public static void main(String args[]) throws Exception {
        ...
        //String pathSOA = "/home/rubens/Experimentos/LSTMDataset/pythonMod/configSOA/SOA1/";
        //String pathLog = "/home/rubens/Experimentos/LSTMDataset/pythonMod/logs/";
       // pathLogsUsedCommands = "/home/rubens/Experimentos/LSTMDataset/pythonMod/commandsUsed/COMM1/";
    ...
    private static boolean processarMatch(String pathLog, String arquivo, int map) {
        ...
        if(fileIsScriptedAI(arquivo)){
            ...
            try {
                return scriptMatch.run(itens[0].trim(),
                        itens[1].trim(),
    ...
    private static boolean fileIsScriptedAI(String arquivo) {
        for (String ais : SCRIPTS) {
            if(arquivo.contains(ais)){
                return true;
            }
        }
        return false;
