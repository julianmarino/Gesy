...
//                decodeScripts2(utt, new ArrayList<>(getListIfInteger("3;")),scriptsTable1,"RR_OURGRAMMAR").get(0)
              ...
              decodeScripts2(utt, new ArrayList<>(getListIfInteger("6;")),scriptsTable1,"GPPD_BEST_RR7").get(0),
              decodeScripts2(utt, new ArrayList<>(getListIfInteger("7;")),scriptsTable1,"GPPD_BEST_RR8").get(0),
              decodeScripts2(utt, new ArrayList<>(getListIfInteger("8;")),scriptsTable1,"GPPD_BEST_RR9").get(0),
              decodeScripts2(utt, new ArrayList<>(getListIfInteger("9;")),scriptsTable1,"GPPD_BEST_RR10").get(0),
              decodeScripts2(utt, new ArrayList<>(getListIfInteger("10;")),scriptsTable1,"GPPD_BEST_RR11").get(0),
              decodeScripts2(utt, new ArrayList<>(getListIfInteger("11;")),scriptsTable1,"GPPD_BEST_RR12").get(0),
              decodeScripts2(utt, new ArrayList<>(getListIfInteger("12;")),scriptsTable1,"GPPD_BEST_RR13").get(0),
              decodeScripts2(utt, new ArrayList<>(getListIfInteger("13;")),scriptsTable1,"GPPD_BEST_RR14").get(0)
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("14;")),scriptsTable1,"GPPD_BEST_RR15").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("15;")),scriptsTable1,"GPPD_BEST_RR16").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("16;")),scriptsTable1,"GPPD_BEST_RR17").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("17;")),scriptsTable1,"GPPD_BEST_RR18").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("18;")),scriptsTable1,"GPPD_BEST_RR19").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("19;")),scriptsTable1,"GPPD_BEST_RR20").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("20;")),scriptsTable1,"GPPD_BEST_RR21").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("21;")),scriptsTable1,"GPPD_BEST_RR22").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("22;")),scriptsTable1,"GPPD_BEST_RR23").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("23;")),scriptsTable1,"GPPD_BEST_RR24").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("24;")),scriptsTable1,"GPPD_BEST_RR25").get(0),
//              
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("25;")),scriptsTable1,"GPPD_BEST_RR26").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("26;")),scriptsTable1,"GPPD_BEST_RR27").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("27;")),scriptsTable1,"GPPD_BEST_RR28").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("28;")),scriptsTable1,"GPPD_BEST_RR29").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("29;")),scriptsTable1,"GPPD_BEST_RR30").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("30;")),scriptsTable1,"GPPD_BEST_RR31").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("31;")),scriptsTable1,"GPPD_BEST_RR32").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("32;")),scriptsTable1,"GPPD_BEST_RR33").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("33;")),scriptsTable1,"GPPD_BEST_RR34").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("34;")),scriptsTable1,"GPPD_BEST_RR35").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("35;")),scriptsTable1,"GPPD_BEST_RR36").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("36;")),scriptsTable1,"GPPD_BEST_RR37").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("37;")),scriptsTable1,"GPPD_BEST_RR38").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("38;")),scriptsTable1,"GPPD_BEST_RR39").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("39;")),scriptsTable1,"GPPD_BEST_RR40").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("40;")),scriptsTable1,"GPPD_BEST_RR41").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("41;")),scriptsTable1,"GPPD_BEST_RR42").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("42;")),scriptsTable1,"GPPD_BEST_RR43").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("43;")),scriptsTable1,"GPPD_BEST_RR44").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("44;")),scriptsTable1,"GPPD_BEST_RR45").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("45;")),scriptsTable1,"GPPD_BEST_RR46").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("46;")),scriptsTable1,"GPPD_BEST_RR47").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("47;")),scriptsTable1,"GPPD_BEST_RR48").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("48;")),scriptsTable1,"GPPD_BEST_RR49").get(0),
//              decodeScripts2(utt, new ArrayList<>(getListIfInteger("49;")),scriptsTable1,"GPPD_BEST_RR50").get(0)
