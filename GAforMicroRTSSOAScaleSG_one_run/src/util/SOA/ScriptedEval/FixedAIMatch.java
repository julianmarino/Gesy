...
public class FixedAIMatch {
    ...
    public FixedAIMatch(String pathTableScripts) {
...
//                                            "ManagerClosestEnemy", 1,decodeScripts(utt, iScriptsAi2));
        ...
        if (order == 0) {
            ...
            ai2 = decodeCompletScripts(utt, iScriptsAi2);
        } else {
            ai1 = decodeCompletScripts(utt, iScriptsAi1);
...
//        JFrame w = PhysicalGameStatePanel.newVisualizer(gs,640,640,false,PhysicalGameStatePanel.COLORSCHEME_WHITE);
    ...
    public static AI decodeCompletScripts(UnitTypeTable utt, ArrayList<Integer> iScripts) {
        ...
        for (Integer idSc : iScripts) {
            ...
            if(idSc == 3){
                try {
                    ...
                    Logger.getLogger(FixedAIMatch.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            if(idSc == 4){
